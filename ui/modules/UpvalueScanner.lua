...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/Dzgak/Hydroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Dzgak/Hydroxide/revision/ohaux.lua"))()
